<div id="mainCommands" class="collapsible">
    <div class="commandBar">
        <h3></h3>
        <button type="button" class="toggle open">&#8211;</button>
    </div>
    <div id="mainCommandsBody" class="collapsibleBody">
        
        <div id="topLeft" class="command">
            <div class="main">
                <a class="second"  href="#" id="website"><span class="center">website</span></a>
            </div>
            <div class="second hide">
                <a href="#" class="main" id="website"><span class="center">website</span></a>
            </div>
            <div class="third hide">
                <a href="stats" id="stats"><span class="center">stats</span></a>
            </div>
        ...
        <div id="bottomLeft" class="command">
            <div class="main">
        ...
        <div id="bottomRight" class="command">
            <div class="main">
