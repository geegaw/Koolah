...
define('CONF_PATH', WEBSITE_DIR.'/conf' );
define('KOOLAH_ROOT_CONF', WEBSITE_DIR.'/../conf.php' );
...
Loader::loadFILE(WEBSITE_DIR.'/config.php');
Loader::loadDir( CORE_OBJECTS_PATH );
Loader::loadDir( TYPES_OBJECTS_PATH, true );
Loader::loadDir( SESSION_OBJECTS_PATH );
Loader::loadDir( LOCAL_TYPES_PATH, true );
Loader::loadFILE(WEBSITE_DIR.'/router.php');
